...
export const AmenitiesDetails = {
    "zluxuria": [
        ...
        {
            "svg": <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M9 5L16 19H2L9 5Z" stroke="#cda24b" stroke-width="1.2" stroke-linejoin="round" />
                <path d="M14 14.5L16.8235 11L22 19H16M6 11H12M7 9L5 13M11 9L13 13" stroke="#cda24b" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>,
        ...
        {
            "svg": <svg width="36" height="36" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M34.875 12.5C36.049 12.5 37 13.451 37 14.625C37 15.799 36.049 16.75 34.875 16.75C33.701 16.75 32.75 15.799 32.75 14.625C32.75 13.451 33.701 12.5 34.875 12.5Z" stroke="#cda24b" stroke-width="2" stroke-linejoin="round" />
                <path d="M34.875 28.25C36.049 28.25 37 29.201 37 30.375C37 31.549 36.049 32.5 34.875 32.5C33.701 32.5 32.75 31.549 32.75 30.375C32.75 29.201 33.701 28.25 34.875 28.25Z" stroke="#cda24b" stroke-width="2" stroke-linejoin="round" />
                <path d="M11.312 27.875C12.589 27.875 13.625 28.911 13.625 30.188C13.625 31.465 12.589 32.5 11.312 32.5C10.035 32.5 9 31.465 9 30.188C9 28.911 10.035 27.875 11.312 27.875Z" stroke="#cda24b" stroke-width="2" stroke-linejoin="round" />
                <path d="M11.312 12.5C12.589 12.5 13.625 13.535 13.625 14.812C13.625 16.089 12.589 17.125 11.312 17.125C10.035 17.125 9 16.089 9 14.812C9 13.535 10.035 12.5 11.312 12.5Z" stroke="#cda24b" stroke-width="2" stroke-linejoin="round" />
                <path d="M25 32.5V30.5C25 29.395 24.105 28.5 23 28.5C21.895 28.5 21 29.395 21 30.5V32.5" stroke="#cda24b" stroke-width="2" stroke-linejoin="round" />
                <path d="M25 12.5V14.5C25 15.605 24.105 16.5 23 16.5C21.895 16.5 21 15.605 21 14.5V12.5" stroke="#cda24b" stroke-width="2" stroke-linejoin="round" />
                <path d="M9 12.5H37V32.5H9V12.5Z" stroke="#cda24b" stroke-width="2" stroke-linejoin="round" />
                <path d="M25.682 21.548L31 37.5" stroke="#cda24b" stroke-width="2" stroke-linejoin="round" />
        ...
        {
            "svg": <svg width="36" height="36" viewBox="0 0 45 45" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M23.125 20.375H29.125" stroke="#cda24b" stroke-width="2" />
                <path d="M10.125 16.375H34.125" stroke="#cda24b" stroke-width="2" />
                <path d="M29.125 23.375V13.375C29.125 11.718 27.782 10.375 26.125 10.375C24.468 10.375 23.125 11.718 23.125 13.375M23.125 23.375V13.375C23.125 11.718 21.782 10.375 20.125 10.375C18.468 10.375 17.125 11.718 17.125 13.375" stroke="#cda24b" stroke-width="2" />
